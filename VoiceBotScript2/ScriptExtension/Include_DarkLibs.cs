    ...
    public class TriggerLogic
    {
      ...
      public static object GetInclude(IntPtr windowHandle, string str_include, string str_references = "")
        ...
        return ((object)obj_include);
         ...
         /// <summary>
         /// Author: Darkstrumn
         /// Function: Intially intended to emulate the way VoiceBot stores its macroscripts this also has the effect of
      ...
      public static string Base64Encode(string str_content)
        ...
        return (str_return);
         ...
         /// <summary>
         /// Author: Darkstrumn
         /// Function: Intially intended to emulate the way VoiceBot recalls its macroscripts this also has the effect of
         /// expanding its preserved textual content.
         /// </summary>
         /// <param name="str_content"></param>
         /// <returns></returns>
